...
Since 2013, I have been working in the information security area for an energy utility. For 4 years I have worked in security and risk governance and security auditing then moved to lead the security operations team, which is my current position. Since this company provided me no help for certifications (and they do not care about it), I stayed away from certifications. Later in 2019, the company gave me training and a voucher to take [CompTIA's Security+ exam](/log/comptia-security-plus-guide/), which I enrolled in and got the certification in &approx;1.5 months. This gave me confidence (and the will) to take other certifications.
