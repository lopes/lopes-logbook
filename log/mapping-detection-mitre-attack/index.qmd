...
Recently, I [posted](/log/2025-engineering-detection-rules/) 🔗 on how a structured engineering approach to creating detection rules can benefit a Threat Detection Engineering (TDE) program. In that post, I showed how early engineering can bring benefits, including classifying new detection rules using **MITRE ATT&CK** terms.
