...
In Containment, we can implement some routines to automate part of the tasks, depending on the workflow in place. We could disable and disconnect user sessions, isolate machines, and add firewall rules, for example. Quoting [Cliff Stoll](/log/2024-book-cuckoos-egg/), sometimes *“it's easier to give an apology than get permission.”*
